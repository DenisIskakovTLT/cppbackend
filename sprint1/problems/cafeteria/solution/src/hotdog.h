...
class HotDog {
public:
    // ћинимальна€ и максимальна€ длительность выпекани€ хлеба и приготовлени€ сосиски дл€
    // использовани€ в хот-доге.
    // ≈сли врем€ приготовлени€ ингредиентов хот-дога не попадают в эти интервалы, хот-дог
    // считаетс€ забракованным
